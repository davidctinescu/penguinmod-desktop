...
}, "https://archive.org/"), " under Public Domain licenses."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Accounts"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Login is managed by ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
...
const fromHardcodedDiscord = async userId => {
  const res = await fetch("https://pmupdatereader.jeremygamer13.repl.co/user/".concat(userId));
...
const logoArtists = Promise.all(['593554048188416001'].map(fromHardcodedDiscord));
